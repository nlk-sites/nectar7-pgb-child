										...
										<div class="row refillproductsrow">
											<div class="col-xs-12 col-sm-12 col-md-4 eachRefillProduct">
												...
												<div class="addtocartdiv">
													...
													<a href="<?php echo $cart_url; ?>?add-to-cart=74&exclusive=1" class="btn btn-primary">ADD TO CART</a>
											...
											<div class="col-xs-12 col-sm-12 col-md-4 eachRefillProduct mostPopular">
												...
												<div class="addtocartdiv">
													...
													<a href="<?php echo $cart_url; ?>?add-to-cart=97&exclusive=1" class="btn btn-primary">ADD TO CART</a>
													<img src="<?php bloginfo('stylesheet_directory'); ?>/images/card_small.png" class="card_xs" />
												</div>
											</div>
											<div class="col-xs-12 col-sm-12 col-md-4 eachRefillProduct">
												...
												<div class="addtocartdiv">
													...
													<a href="<?php echo $cart_url; ?>?add-to-cart=98&exclusive=1" class="btn btn-primary">ADD TO CART</a>
													<img src="<?php bloginfo('stylesheet_directory'); ?>/images/card_small.png" class="card_xs" />
												</div>
											</div>
										</div>
