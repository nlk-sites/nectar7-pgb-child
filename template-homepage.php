											...
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-4 col-sm-5 col-xs-12 product-image-col">
														<img src="/wp-content/uploads/2015/10/Niagen-2.png" class="img-responsive product-image" alt="Niagen&reg; (NAD + ACTIVATOR)"/>
													</div>
												</div>
											</div>
										</div>
										<div class="row leftboxedcontent productbox boxblue">
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-4 col-sm-5 col-xs-12 product-image-col">
														<img src="/wp-content/uploads/2015/10/collagen-2.png" class="img-responsive product-image" alt="Niagen&reg; (NAD + ACTIVATOR)"/>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="hidden-xs hidden-sm col-md-12 border-bottom">
												<div class="rightboxedcontent lightbluebox">
													<a title="Learn how N7 Niagen &amp; Collagen benefits you" href="<?php bloginfo('url'); ?>/nectar7-niagen-collagen/">
														...
														<img src="/wp-content/uploads/2015/10/collagen-2.png" class="img-responsive product-image" alt="Niagen&reg; & COLLAGEN"/>
													</a>
